...
import { selectAllPosts, selectIsLoading, selectErrorMessage } from '../../Store/post.slice';
  ...
  return <>
    <div className="bounding-box">
      <div className="site-header">
        ...
        <button data-test="create-new-post-button" onClick={() => navigate("/posts/new" )}>Create a new post</button>
      </div>
